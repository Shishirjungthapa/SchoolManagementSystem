...
function Home() {
    ...
    return (
      ...
      <div className="">
        ...
        <Navbar/>
            <div className="relative flex flex-col-reverse items-start w-full h-full pb-12 mt-10 overflow-hidden overflow-x-hidden md:-mt-4 md:h-4/5 justify-evenly md:flex-row lg:flex-row md:justify-center">
              <div className="relative z-0 flex flex-col pl-6 pr-4 text-center text-white md:pr-0 md:pl-8 pt-7 md:pt-28 h-2/3 lg:w-3/5 md:w-1/2 lg:h-full md:h-2/3 lg:gap-y-10 md:gap-y-6 gap-y-5">
              ...
              <div className="flex items-center justify-center w-full pt-3 overflow-hidden lg:mt-10 md:mt-0 h-1/3 lg:h-auto md:h-auto md:w-1/2 lg:w-2/5">
                <img src='/images/studentimg1.png' className="w-auto h-full lg:w-full lg:h-full md:w-auto md:h-11/12" alt="Student illustration"/>
              </div>
            </div>
        </div>
